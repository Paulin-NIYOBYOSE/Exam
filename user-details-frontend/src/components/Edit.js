                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <select name="title" value={user.title} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <div className="mb-4">
                            ...
                            <select name="position" value={user.position} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <div className="mb-4 flex gap-4">
                            ...
                            <div className="w-1/2">
                                ...
                                <select name="employees" value={user.employees} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div className="bg-blue-600 p-6 rounded-lg text-white">
                        ...
                        <div className="mb-4">
                            ...
                            <input name="additionalInfo"
                                value={user.additionalInfo} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        </div>
                        <div className="mb-4 flex gap-4">
                            <div className="w-1/2">
                        ...
                        <div className="mb-4">
                            <label className="block text-sm font-bold mb-2">
                                <input type="checkbox" className="mr-2 leading-tight" /> I do accept the <a href="#blank" className="text-white underline">Terms and Conditions</a> of your site.
                            </label>
                        </div>
